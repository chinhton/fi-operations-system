...
const NAV_GROUPS = [
  { label: "Operations", tabs: ["dashboard", "workOrders", "corrective"] },
  { label: "Assets & Resources", tabs: ["assets", "hardware", "keys"] },
  { label: "Records", tabs: ["manuals", "contractors", "templates", "history"] }
];
