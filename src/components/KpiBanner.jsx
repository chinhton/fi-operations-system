...
export default function KpiBanner({ complianceRate, operationalCount = 0, overdueCount = 0, calibrationCount = 0, correctiveCount = 0 }) {
  return (
        ...
        <div className="p-6 xl:w-2/3 flex flex-col justify-center bg-gray-50/50">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
            <div className="bg-white border border-green-200 p-4 rounded-xl shadow-sm flex flex-col justify-between">
              <span className="text-[10px] uppercase font-extrabold text-green-700 tracking-wider">Operational</span>
